...
FLASK_PORT = int(os.getenv('FLASK_PORT', 50))
BASE_URL = os.getenv('BASE_URL', '/auth/v1') #как вариант разделить корневой эндпоинт


class PostgreTestSettings(BaseSettings):
